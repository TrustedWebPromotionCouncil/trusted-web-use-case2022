...
export const storedVC: StoredVC = {
  credentialID: "0B9E8006-C5B3-4041-B65D-7F405CDB4F8D",
  format: "jwt_vc",
...
export const selectableTransactions = [
  {
    value: "006-1708-317-177",
    label: "SiTECH3D",
    maker: "(株)建設システム",
    vendor: {
      name: "SiTECH3D",
  ...
  {
    value: "006-1806-710-186",
    label: "INNOSiTEセット（Site-Scope+SiTECH3D）",
    maker: "(株)建設システム",
    vendor: {
      name: "SiTECH3D",
      url: "https:sample.com",
  ...
  {
    value: "006-1806-712-186",
    label: "INNOSiTEセット（Site-Scope+SiTECH3D）オプション",
    maker: "(株)建設システム",
    vendor: {
      name: "SiTECH3D",
      url: "https:sample.com",
  ...
  {
    value: "006-1806-713-186",
    label: "Site-Scope+ICTオプション",
    maker: "(株)建設システム",
    vendor: {
      name: "SiTECH3D",
      url: "https:sample.com",
